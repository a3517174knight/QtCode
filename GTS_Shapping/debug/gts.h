...
#define CMD_ERROR_READ_LEN             -2    /* read data length error */
#define CMD_ERROR_READ_CHECKSUM        -3    /* checksum error */

#define CMD_ERROR_WRITE_BLOCK          -4    /* write pci fail */
#define CMD_ERROR_READ_BLOCK           -5    /* read pci fail */

#define CMD_ERROR_OPEN                 -6    /* error to open device */
#define CMD_ERROR_CLOSE                -6    /* error to close device */
#define CMD_ERROR_DSP_BUSY             -7    /* DSP busy */

#define CMD_LOCK_ERROR                 -8    /*multi-thread lock error*/
#define CMD_DMA_ERROR                  -9    /*dma transmission error*/
#define CMD_COMM_ERROR                     -10    /*pcie comm error*/
#define CMD_LOAD_RINGNET_ERROR           -11    /*load ringnet dll error*/
#define CMD_RINGNET_STIME_ERROR           -12    /*load ringnet dll error*/

#define CMD_RINGNET_ENC_ERROR           -13    /*encoder initial error*/

#define CMD_RNVERSION_MATCH_ERROR           -14   /*ringnet version error*/
#define CMD_MCVERSION_MATCH_ERROR           -15   /*dll error,need to update dll*/
#define CMD_MCVERSION_MATCH_WARNING          15   /*dll error,without some functions*/
#define CMD_DSPVERSION_MATCH_WARNING          16   /*dsp is too old*/
...
GT_API GTN_SetScanPosSuperposeParameter(short core,short crd,TScanPosSuperposeParamter param);
...
GT_API GTN_SetMotionSmoothWorkMode(short core,short type,short index,short mopde);
...
GT_API GTN_SetPosCompareFifoMode(short core,short index,short mode,short enable);
GT_API GTN_GetPosCompareFifoData(short core,short index,long startNum,long count,long *pDataX,long *pDataY,long *pCount);
GT_API GTN_ReadPosCompareResult(short core,short index,short count,long *pDataX,long *pDataY,long *pCount);
